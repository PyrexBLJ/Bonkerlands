...
public:
	...
	bool operator==(const FVector vec)
	{
		return (this->X == vec.X && this->Y == vec.Y && this->Z == vec.Z);
	}
	bool empty()
...
struct FColor
{
	unsigned char                                      A;                                                		// 0x0000 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      R;                                                		// 0x0001 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      G;                                                		// 0x0002 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      B;                                                		// 0x0003 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
